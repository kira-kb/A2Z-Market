...
export default function CarouselCard({
  ...
  return (
    <div className="relative min-w-[260px] sm:min-w-[320px] md:min-w-[360px] lg:min-w-[400px] p-4">
      <Card
        {...props}
        className="flex flex-col overflow-hidden border rounded-2xl shadow transition hover:shadow-lg dark:bg-gray-800 dark:border-gray-700"
      >
        <Image
        ...
        <CardContent className="flex flex-col gap-3 p-4">
          ...
          <Link
            href={`/shop/${data.id}`}
            className="inline-flex items-center self-start text-sm font-medium text-blue-600 hover:underline"
          >
