...
{
  /* <Image src={new URL("https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")} /> */
}
// ?????????????????????????????????????
...
//       name: "Accessories",
//       image:
//         "https://images.unsplash.com/photo-1523775633436-a0e60f79b46a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
//   return (
//     <div className="container mx-auto px-4 py-12 dark:bg-gray-800 dark:text-white">
...
//             <div className="relative rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow dark:bg-gray-700">
//               <img
//                 src={category.image}
//                 alt={category.name}
//                 className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-300"
//               />
//               <div className="absolute inset-0 bg-black/40 dark:bg-gray-900/40"></div>
//               <div className="absolute bottom-4 left-4 p-2 bg-white/80 text-black dark:bg-gray-900/80 dark:text-white">
